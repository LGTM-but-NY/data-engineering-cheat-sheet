...
\begin{multicols}{3}
    ...
    \paragraph{Các Quy tắc Cốt lõi (Phải nhớ)}
    \begin{enumerate}[leftmargin=*, label={\textbf{\arabic*.}}]
    ...
    \begin{description}[leftmargin=*, font=\bfseries\color{red!70!black}, itemsep=4pt]
        ...
        \item[Q: Checkpoint trong Spark Streaming?] $\rightarrow$ Lưu \textbf{RDD + metadata} xuống HDFS để recover khi lỗi.
        ...
        \item[Q: Master-Master vs Master-Slave?] $\rightarrow$ \textbf{M-M:} Cả hai đều write được (high availability).
